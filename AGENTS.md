...
1. `docs/proposal.md` — 需求提案 + 全部已确认决策（17 项）
2. `docs/high-Level Design.md` — 概要设计：18 个模块划分、接口签名、数据流
3. `docs/brief.md` — 给项目把控者看的决策摘要（人话版，你也应该扫一眼）

**禁止**：在未阅读 `proposal.md` 和 `high-Level Design.md` 前直接写代码或修改设计。
